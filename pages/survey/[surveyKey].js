...
import birthchart from "../../assets/reveals.png";
      ...
      <form onSubmit={(e) => handleSubmit(e)} className="padding-5">
        {step === 1 ? (
         ...
         />
          ...
          <Fade cascade={true} triggerOnce={false}>
            <h1 className="text-center text-Black font-popins font-semibold text-xs title-costume">
            Welche der folgenden Eigenschaften spiegelt Ihre Persönlichkeit wider
            </h1>

            <p className="text-center text-Black text-[15px]">
              Bitte kreuzen Sie die für Sie treffendsten Optionen an. Diese Angaben werden mit den Informationen aus dem Geburtshoroskop übereinstimmen.
            </p>
            <PersonalityNature
          ...
          <Fade cascade={true} triggerOnce={false}>
             <h1 className="text-center text-Black font-popins font-semibold text-xs title-costume">
             Wo würden Sie gerne den Rest Ihres Lebens verbringen?
             </h1>
          ...
          <Fade cascade={true} triggerOnce={false}>
            <p className="text-center text-Black font-popins ml-10 mb-5  font-size16">
            Lassen Sie uns Sie besser kennenlernen
                </p>
            <h1 className="text-center text-Black font-popins font-semibold text-xs title-costume ">
            ...
            <div className="border-2 md:mx-[0px] border-grayborder bg-white rounded-2xl px-10 md:mt-0 mt-30 py-5 paddings-c">
              ...
              <div className="flex justify-start items-start">
                ...
                Der Künstler hat die Ergebnisse meiner Tarot-Lesung und Numerologie gekonnt in eine Skizze übersetzt, die sich wirklich persönlich angefühlt hat.
                </p>
              </div>
            </div>
          </Fade>
          ...
          <>
            <Fade cascade={true} triggerOnce={false}>
              <h1 className="text-center text-Black font-popins font-semibold text-xs title-costume">
              Bitte warten Sie, während wir Sie verbinden
              </h1>
              <Fade>
                <Spinner />
              </Fade>
